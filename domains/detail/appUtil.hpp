...
#include "../geometry/RigidBodyGeometry.hpp"
#include <limits>
...
ompl::base::ProjectionEvaluatorPtr allocGeometricStateProjector(const base::StateSpacePtr &space, MotionModel mtype,
...
ompl::control::DecompositionPtr allocDecomposition(const base::StateSpacePtr &space, MotionModel mtype,
